    ...
    <nav class="navbar navbar-dark  bg-none navbar-expand-lg sticky-top">
        ...
        <div class="collapse navbar-collapse new" id="navbarlinks">
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="navbar-item">
                    <a href="fixture.php" class="nav-link p-3 active">Fixtures</a>
                </li>
                <li class="navbar-item">
        ...
        <div class="container my-2">
            <div class="col-sm-6 mx-auto text-center">
                ...
                <?php
                    ...
                    $result = mysqli_query($connect, "SELECT * FROM fixtures ORDER by dt DESC");
                    ...
                    while ($row = mysqli_fetch_array($result)) {
                        ...
                        echo "<div class=\"text-center main mx-auto\" align=center><table class=\"text-center main mx-auto\"><tr>$date</tr>";
                        echo "<tr>
