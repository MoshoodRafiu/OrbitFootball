...
<body>
    ...
    if (isset($_POST['submit'])){
        ...
        if (($type=="image/jpeg") || ($type=="image/jpg") || ($type=="image/png")){
            ...
            mysqli_query($connect, "INSERT INTO player (player) VALUES ('$image')");
    ...
    <div class="row">
        <div class="col-9 col-md-6 col-lg-4 mx-auto text-center">
            <div class="card mb-5">
                <div class="bg card-title"><h2 class="py-3">Update player of the week</h2></div>
                <form action="player.php" enctype="multipart/form-data"  class="mx-5 my-3"  method="post">
